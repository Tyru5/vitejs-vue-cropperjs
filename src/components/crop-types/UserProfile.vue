    ...
    <div class="w-[600px] h-[700px] bg-slate-100 drop-shadow-lg">
      <div class="grid grid-rows-3 grid-cols-12 gap-y-10 gap-x-6 m-6">
        ...
        <div class="row-start-4 col-span-5 b">
          <input type="text" id="first_name" class="bg-transparent border-b-2 border-gray-300 text-gray-900 block w-full p-2.5 focus:outline-none" placeholder="First name">
        </div>
