  ...
  <div class="grid h-screen place-items-center">
    <div class="w-[600px] h-[700px] bg-slate-100 drop-shadow-lg flex flex-col gap-6">
        ...
        <div class="px-6 flex">
            ...
            <textarea type="text" id="email" class="bg-transparent border-b-2 border-gray-300 text-gray-900 pl-2 focus:outline-none grow" placeholder="Text Description"></textarea>
        </div>
        <div class="flex space-x-2 justify-end ">
