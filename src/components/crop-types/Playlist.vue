...
<template>
  <div class="grid h-fit place-items-center">
    <div class="w-[600px] h-[900px] bg-slate-100 drop-shadow-lg flex flex-col gap-6 mt-20 rounded-3xl">
      ...
      <div class="px-6 flex items-center">
        ...
        <input
          ...
          placeholder="PDF, Doc, CSV, or Image"
        />
      </div>
      ...
      <div class="flex space-x-2 justify-end">
        <button
          type="button"
          class="inline-block w-30 px-6 py-2.5 bg-zinc-300 text-zinc-400 font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-slate-500 hover:shadow-lg focus:slate-500 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-zinc-600 active:shadow-lg transition duration-150 ease-in-out font-semibold tracking-widest mr-6"
        >
          ADD LINK
        </button>
      </div>
      ...
      <div class="px-6 flex">
        ...
        <textarea
          type="text"
          id="textDescription"
          class="bg-transparent border-b-2 border-gray-300 text-gray-900 pl-2 focus:outline-none grow"
